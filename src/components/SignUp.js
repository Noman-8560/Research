				...
				<div className="col-xxl-4 col-xl-5 col-lg-5 col-md-7 col-sm-9">
					<div className="card shadow-lg border-0">
						<div className="card-body  p-5  lgn">
							<h1  className="fs-4 card-title fw-bold mb-4 txt ">Sign Up as Scholar</h1>
							<form  className="needs-validation"  autocomplete="off">
								...
								<div className="mb-3">
									<label  className="mb-2 text-muted" for="password">Confirm Password</label>
									<input id="password" type="password" className="form-control lgn" name="password" required />
								</div>
	
								<div className="align-items-center d-flex">
								<Link to="/login" class="btn1  mx-auto">Sign Up</Link>                          
								</div>

								<div className="card-footer mt-3 border-0 text-muted" >
									<div className="text-center">
								      Don't have an account? <Link to="/login" className='text-white' >Login</Link>
							        </div>
						        </div>
							</form>
						</div>
